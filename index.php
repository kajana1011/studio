...
<main>
    <!-- Hero Section -->
    <section class="hero-section bg-dark text-white py-5" style="background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('assets/images/hero-bg.jpg') center/cover;">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                        <a href="booking.php" class="btn btn-light btn-lg px-4">Book a Session</a>
